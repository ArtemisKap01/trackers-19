...
public class quizteachers extends JPanel {
	...
	ButtonGroup bg, bg2, bg3, bg4, bg5 ,bg6, bg7, bg8, bg9, bg10, bgcon;
	  //Strings for JButtons//
       ...
       String apcon1[] = {"Ναι"}; 
       String apcon2[] = {"Όχι"}; 
       Image qzimg = new ImageIcon(quizteachers.class.getResource("icons/student.png")).getImage().getScaledInstance(50, 50, Image.SCALE_SMOOTH);
  	 Image qzimg2 = new ImageIcon(quizteachers.class.getResource("icons/student(1).png")).getImage().getScaledInstance(50, 50, Image.SCALE_SMOOTH);
   ...
   //Button Initialization//
     ...
     button.addMouseListener(new MouseAdapter() {
     	...
     	public void mouseClicked(MouseEvent e) {
     		...
     		if((btncon1.isSelected()) && (btn1a.isSelected())  && (btn2a.isSelected()) && (btn3a.isSelected()) && (btn4a.isSelected()) && 
     				(btn5a.isSelected())&& (btn6a.isSelected())&& (btn7a.isSelected())&& (btn8a.isSelected())&& (btn9a.isSelected()) && (btn10a.isSelected()) ||
     			//If first four are picked,the teacher is required to go into quarantine for 14 days and test for Covid-19//
     			...
     			//If one of the first four are picked, the teacher is required to go into quarantine for 14 days and test for Covid-19//
     				btn1a.isSelected() && btn2b.isSelected() && btn3b.isSelected() && btn4b.isSelected() || 
     				btn2a.isSelected() && btn1b.isSelected() && btn3b.isSelected() && btn4b.isSelected() ||
     				btn3a.isSelected() && btn1b.isSelected() && btn2b.isSelected() && btn4b.isSelected() ||
     			    btn4a.isSelected() && btn1b.isSelected() && btn2b.isSelected() && btn3b.isSelected() ) {
   		      JOptionPane.showMessageDialog(null, "Καραντίνα για 14 ημέρες και τεστ COVID-19", "Προσοχή!", JOptionPane.OK_OPTION);
   		   //auto 8a to kanoume otan enw8ei me ta alla//JEmail mframe = new JEmail();
     ...
     add(button);
       ...
       ques10.setBounds(308, 366, 123, 14);
       add(ques10);
