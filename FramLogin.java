...
public class FramLogin extends JFrame {
    ...
    private Image logoimg = new ImageIcon(FramLogin.class.getResource("icons/Science-University-icon.png")).getImage().getScaledInstance(90, 90, Image.SCALE_SMOOTH);
	...
	public FramLogin() {
		...
		panel.setBounds(192, 154, 209, 37);
		...
		panel_1.setBounds(192, 202, 209, 37);
		...
		txtPassword.setSize(167, 20);
		txtPassword.setLocation(new Point(10, 11));
		txtPassword.setText("Password");
		...
		LoginBtn.setBackground(new Color(165, 42, 42));
		LoginBtn.setBounds(227, 290, 123, 37);
		...
		panel_3.setBounds(184, 250, 321, 20);
		contentPane.add(panel_3);
		panel_3.setLayout(null);
		
		lblLoginMessage.setBackground(new Color(222, 184, 135));
		lblLoginMessage.setForeground(new Color(139, 0, 0));
		lblLoginMessage.setFont(new Font("Arial", Font.PLAIN, 11));
		lblLoginMessage.setBounds(10, 0, 276, 20);
		panel_3.add(lblLoginMessage);
		
		
		
		JLabel logo = new JLabel("");
		logo.setBounds(249, 40, 101, 103);
